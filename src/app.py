...
activities = {
    ...
    "Basketball Club": {
        ...
        "max_participants": 15,
        "participants": ["carlos@mergington.edu", "mia@mergington.edu"]
    },
    "Drama Club": {
        "description": "Acting, production, and stagecraft for school plays",
        "schedule": "Wednesdays, 3:30 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["luke@mergington.edu", "ella@mergington.edu"]
    },
    "Art Workshop": {
    ...
    "Debate Team": {
        ...
        "max_participants": 16,
        "participants": ["sarah@mergington.edu", "owen@mergington.edu"]
    },
    "Math Club": {
